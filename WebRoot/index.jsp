...
<html>
  ...
  <body>
    <div  style="width:80%;margin:0 auto;padding-top: 30px;"><br/>
    	...
    	<div class="formbody" style="margin:0 auto;">
    		<fieldset >
    		<legend align="left">身份认证</legend>
    			...
    			<div style="margin:10px auto"><label for="stuname">姓名</label><s:textfield name="stuname" id="stuname" /></div>
   				<div style="margin:10px auto"><label for="stunum">学号</label><s:textfield name="stunum" id="stunum" /></div>
 				<div style="margin:10px auto"><s:submit id="button" value="开始作答" style="background:#A4D3EE;weight:60px;height:30px;cursor:pointer;color:#fff"></s:submit></div>
				</s:form>
				</div>
    		</fieldset>
    	</div>
